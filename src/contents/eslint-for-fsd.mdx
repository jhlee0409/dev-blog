...
tags: "eslint, FSD, frontend-design-pattern"
---

# FSD 아키텍처를 위한 ESLint 설정
...
불필요한 import를 방지하고 번들 크기를 최적화하기 위해 다음과 같은 방식을 사용한다:

```typescript
// 최적화 전: 전체 모듈 import
import { everything } from "@/shared/utils";

// 최적화 후: 필요한 함수만 import
import { specificFunction } from "@/shared/utils/specificFile";
```
...
더 궁금하신 부분이 있거나, 실제 프로젝트에서 적용하면서 발생할 수 있는 특정 시나리오에 대해 논의하고 싶으시다면 댓글로 남겨주세요.
