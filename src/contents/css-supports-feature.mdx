...
summary: "@supports 파헤치기"
tags: "supports, css, featureQuery"
---
...
> *e.g. 브라우저가* [_자식 결합자_](https://developer.mozilla.org/ko/docs/Web/CSS/Child_combinator)*를 지원할 때 해당* `_CSS_` *를 적용한다*
