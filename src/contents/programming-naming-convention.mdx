...
summary: "네이밍 컨벤션 파헤치기"
tags: "programming, naming convention"
---
...
_e.g. camelCase, isOpen, setState, namingConvention_
...
_e.g. PascalCase, MyClass, MyComponent, NamingConvention_
...
_e.g. snake_case, is_open, ENUM_TYPE, naming_convention_
...
_e.g. kebab-case, is-open, set-state, naming-convention_
